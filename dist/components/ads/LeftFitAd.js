...
function LeftFitAd() {
    ...
    (0, react_1.useEffect)(() => {
        ...
        return () => {
            ...
            if (globalAdfit)
                globalAdfit.destroy("DAN-K6fFoDz07jKGdUEj");
        };
    }, []);
    // const ins = createAdTag("DAN-K6fFoDz07jKGdUEj");
    return (react_1.default.createElement("div", { className: "ad-container", ref: ad },
        react_1.default.createElement("ins", { className: "kakao_ad_area", style: { display: "none" }, "data-ad-unit": "DAN-K6fFoDz07jKGdUEj", "data-ad-width": "320", "data-ad-height": "100" })));
}
exports.default = LeftFitAd;
