...
function Reword({ reword }) {
    return (react_1.default.createElement("div", { className: "reword" },
        react_1.default.createElement("img", { src: `/images/${encodeURIComponent((0, commons_1.getNameExceptColon)(reword.item.name))}.png`, title: reword.item.name }),
        react_1.default.createElement("div", { className: "reword-info" },
            react_1.default.createElement("span", { title: reword.item.name }, reword.item.name),
