    ...
    return (react_1.default.createElement("header", null,
        ...
        react_1.default.createElement("div", { className: "header" },
            ...
            react_1.default.createElement("nav", { className: `${isOpen ? "open" : ""}`, onMouseEnter: () => setIsOpen(true), onMouseLeave: () => setIsOpen(false) },
                ...
                react_1.default.createElement("div", { className: "nav-element" },
                    react_1.default.createElement(react_router_dom_1.Link, { to: "/dsr/guides", className: "text-nav" }, "\uAE30\uCD08 \uAC00\uC774\uB4DC")),
                react_1.default.createElement("div", { className: "nav-element" },
                    react_1.default.createElement(react_router_dom_1.Link, { to: "/dsr/digimons/digidex", className: "text-nav" }, "\uB514\uC9C0\uBAAC"),
                    react_1.default.createElement("div", { className: "nav-subs" },
                        react_1.default.createElement(react_router_dom_1.Link, { to: "/dsr/digimons/digidex", className: "text-nav" }, "\uB514\uC9C0\uBAAC \uB3C4\uAC10"),
                        react_1.default.createElement(react_router_dom_1.Link, { to: "/dsr/digimons/evolutions", className: "text-nav" }, "\uC9C4\uD654\uD2B8\uB9AC"))),
                react_1.default.createElement("div", { className: "nav-element" },
                ...
                react_1.default.createElement("div", { className: "nav-element" },
                    react_1.default.createElement(react_router_dom_1.Link, { to: "/dsr/tools/adjustments", className: "text-nav" }, "\uB3C4\uAD6C"),
                    react_1.default.createElement("div", { className: "nav-subs" },
                        react_1.default.createElement(react_router_dom_1.Link, { to: "/dsr/tools/adjustments", className: "text-nav" }, "\uAD50\uC815 \uC2DC\uBBAC"),
                        react_1.default.createElement(react_router_dom_1.Link, { to: "/dsr/tools/babies", className: "text-nav" }, "\uC720\uB144\uAE30 \uC2DC\uBBAC"),
                        react_1.default.createElement(react_router_dom_1.Link, { to: "/dsr/tools/potentials", className: "text-nav" }, "\uD3EC\uD150\uC15C \uC2DC\uBBAC"),
                        react_1.default.createElement(react_router_dom_1.Link, { to: "/dsr/tools/skills", className: "text-nav" }, "\uC2A4\uD0AC\uAC15\uD654 \uC2DC\uBBAC"))),
                react_1.default.createElement("div", { className: "nav-element" },
                    react_1.default.createElement(react_router_dom_1.Link, { to: "/dsr/items/combinations", className: "text-nav" }, "\uC544\uC774\uD15C")),
                react_1.default.createElement("div", { className: "nav-element" },
