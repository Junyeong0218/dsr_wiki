...
exports.getTotalStats = exports.generateTenPotentials = exports.getDefaultPotentials = void 0;
const rate = {
    type: {
        "ONE": 2,
        "ROW": 1,
...
exports.generateTenPotentials = generateTenPotentials;
const getDefaultPotentials = () => {
    return [
        [
...
exports.getDefaultPotentials = getDefaultPotentials;
const getTotalStats = (potentials) => {
    const total = [
        { statType: "힘", value: 0 },
        { statType: "지능", value: 0 },
        { statType: "수비", value: 0 },
    ...
    for (let i = 0; i < potentials.length; i++) {
        ...
        column: for (let j = 0; j < row.length; j++) {
            const cell = row[j];
            if (cell.statType === "BLANK")
                continue column;
