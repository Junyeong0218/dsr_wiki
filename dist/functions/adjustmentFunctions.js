...
exports.getDefaultSpentItems = exports.adjustTwo = exports.adjustFailToSuccess = exports.adjustAll = exports.hasSuccessedAdjustsOverTwo = exports.hasFailAdjust = exports.isFirstAdjust = exports.getDefaultGauges = void 0;
...
exports.getDefaultGauges = getDefaultGauges;
const isFirstAdjust = (gauges) => {
    let count = 0;
...
exports.isFirstAdjust = isFirstAdjust;
const hasFailAdjust = (gauges) => {
    let count = 0;
    gauges.forEach(gauge => {
        if (gauge.type === "FAIL")
            count++;
...
exports.hasFailAdjust = hasFailAdjust;
const hasSuccessedAdjustsOverTwo = (gauges) => {
    let count = 0;
    gauges.forEach(gauge => {
        if (gauge.type !== "NONE" && gauge.type !== "FAIL")
            count++;
    });
    return count > 1;
};
exports.hasSuccessedAdjustsOverTwo = hasSuccessedAdjustsOverTwo;
const getImpossibleStats = (gauges) => {
...
const getRandomNumberExceptZero = (digit) => Math.round(Math.random() * digit) + 1;
const createSuccessTable = (cases) => {
...
const getRandomStat = (impossibles) => {
    let cases = [
...
exports.adjustAll = adjustAll;
const adjustFailToSuccess = (guages, index) => {
    let rerollCount = 0;
...
exports.adjustFailToSuccess = adjustFailToSuccess;
const adjustTwo = (guages, indexes) => {
...
exports.adjustTwo = adjustTwo;
const getDefaultSpentItems = () => {
    return [
        {
            item: (0, getItemsFunctions_1.getItemByName)("제로유니트"),
            count: 0
        },
        {
            item: (0, getItemsFunctions_1.getItemByName)("빛나는 제로유니트"),
            count: 0
        },
        {
            item: (0, getItemsFunctions_1.getItemByName)("부서진 제로유니트"),
            count: 0
        },
    ];
};
exports.getDefaultSpentItems = getDefaultSpentItems;
